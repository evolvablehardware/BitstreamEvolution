...
@pytest.mark.parametrize(
    ...
    [
        "config.ini",
        "config1.ini",
        "thisIsAVeryLongConfigNameThatShouldWorkWellConfig.ini",
        "conf_01.ini",
        "conf.file.ini",
    ],
)
def test_config_only_is_interpreted(
    flag: str, configName: str, evolve_arg_parse_function: Callable
):
...
def test_base_config_only_is_interpreted(
    flag: str, configName: str, evolve_arg_parse_function: Callable
):
...
def test_output_directory_only_is_interpreted(
    flag: str, outputName: str, evolve_arg_parse_function: Callable
):
...
def test_description_only_is_interpreted(
    flag: str, descriptionText: str, evolve_arg_parse_function: Callable
):
...
def test_specify_default_action_alone_is_interpreted(
    flag: str, evolve_arg_parse_function: Callable
):
