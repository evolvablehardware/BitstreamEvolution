...
class Microcontroller:
    ...
    def get_fpga(self):
        """
        Get the currently active FPGA (used for transferability experiments)
    ...
    def simple_measure_pulses(self, data_filepath, pin):
        ...
        # The MCU also expects a byte string representing the pin
        self.__serial.write(bytes(str(pin)))
        start = time()
    ...
    def measure_signal(self, data_filepath, pin):
        """
