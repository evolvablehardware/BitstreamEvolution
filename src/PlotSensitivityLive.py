...
def run():
    ...
    def animate_sensitivity(i):
        ...
        if not config.is_pulse_func():
            ax4.set(
                xlabel="Mean Voltage (Normalized)",
                ylabel="Count",
                title="Circuit Voltage per Trial",
            )
            ax5.set(
                xlabel="Trial",
                ylabel="Mean Voltage (Normalized)",
                title="Circuit Voltage per Trial",
            )
        else:
    ...
    def animate_temp_humidity(i):
        ...
        if config.is_pulse_func():
            ...
            ax8.set(
                xlabel="Temperature",
                ylabel="Mean Voltage (Normalized)",
                title="Temperature vs Circuit Voltage per Trial",
            )
            ax9.set(
                xlabel="Humidity",
                ylabel="Mean Voltage (Normalized)",
                title="Humidity vs Circuit Voltage per Trial",
            )
    ...
    def animate_avg_temp_humidity(i):
        ...
        ax10.set(
            ...
            title="Temperature vs Average Circuit Fitness",
        )
        ax12.clear()
        ...
        ax14.set(
            xlabel="Temperature",
            ylabel="Standard Deviation of Fitness",
            title="Temperature vs Standard Deviation of Circuit Fitness",
        )
        ax16.clear()
        ...
        ax11.set(
            xlabel="Humidity", ylabel="Average Fitness", title="Humidity vs Average Circuit Fitness"
        )
        ax13.clear()
        ...
        ax15.set(
            xlabel="Humidity",
            ylabel="Standard Deviation of Fitness",
            title="Humidity vs Standard Deviation of Circuit Fitness",
        )
        ax17.clear()
        ...
        if config.is_pulse_func():
            ax12.set(
                xlabel="Temperature", ylabel="Average Pulses", title="Temperature vs Average Pulses"
            )
            ax13.set(xlabel="Humidity", ylabel="Average Pulses", title="Humidity vs Average Pulses")
            ax16.set(
                xlabel="Temperature",
                ylabel="Standard Deviation of Pulses",
                title="Temperature vs Standard Deviation of Pulses",
            )
            ax17.set(
                xlabel="Humidity",
                ylabel="Standard Deviation of Pulses",
                title="Humidity vs Standard Deviation of Pulses",
            )
        else:
            ax12.set(
                xlabel="Temperature",
                ylabel="Average of Mean Voltages (Normalized)",
                title="Temperature vs Average Circuit Voltage per Trial",
            )
            ax13.set(
                xlabel="Humidity",
                ylabel="Average of Mean Voltages (Normalized)",
                title="Humidity vs AVerage Circuit Voltage per Trial",
            )
            ax16.set(
                xlabel="Temperature",
                ylabel="Standard Deviation of of Mean Voltages (Normalized)",
                title="Temperature vs Standard Deviation of Average Circuit Voltage per Trial",
            )
            ax17.set(
                xlabel="Humidity",
                ylabel="Standard Deviation of of Mean Voltages (Normalized)",
                title="Humidity vs Standard Deviation of Average Circuit Voltage per Trial",
            )
    ...
    def animate_change_over_time(i):
        ...
        time_axes[0].set(
            xlabel="Trial", ylabel="Fitness", title="Fitness vs Temperature and Humidity over Time"
        )
        time_axes[3].plot(time_points, data[1], color=accent_color)
        time_axes[3].set(
            xlabel="Trial", ylabel="Data 2", title="Data 2 vs Temperature and Humidity over Time"
        )
        ...
        for i in range(2):
            ...
            time_axes[3 * i + 2].axis["right2"] = time_axes[3 * i + 2].new_fixed_axis(
                loc="right", offset=(60, 0)
            )
